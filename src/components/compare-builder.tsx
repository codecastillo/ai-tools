...
export default function CompareBuilder({ tools }: CompareBuilderProps) {
  ...
  return (
    <div className="rounded-xl border border-white/[0.06] bg-[--color-surface] p-6">
  ...
  return (
    <label className="block">
      ...
      <select
        ...
        className="mt-2 w-full rounded-md border border-white/[0.08] bg-white/[0.02] px-3 py-2.5 text-sm text-ink focus:border-accent/60 focus:outline-none"
      >
