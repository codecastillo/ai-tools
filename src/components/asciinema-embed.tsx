  ...
  return (
    <div className="my-6 overflow-hidden rounded-lg border border-white/[0.10] bg-[--color-bg-elevated,#0a0a0a] shadow-[inset_0_1px_0_rgba(255,255,255,0.03),0_1px_2px_rgba(0,0,0,0.4)]">
      ...
      <a
        ...
        className="group flex items-center gap-3 p-6 transition-colors hover:bg-white/[0.02] motion-reduce:transition-none"
      >
        <span className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/[0.10] bg-white/[0.04] text-accent">
