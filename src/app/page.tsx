          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {stacks.slice(0, 3).map((s) => (
              <Link
                key={s.id}
                href={`/stacks/${s.slug}`}
                className="group flex h-full flex-col rounded-xl border border-white/[0.06] bg-white/[0.02] p-5 transition-all hover:-translate-y-px hover:border-accent/30 hover:bg-accent/[0.04]"
              >
