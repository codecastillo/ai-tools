      ...
      <div className="mt-6 grid gap-12 lg:grid-cols-[1fr_200px]">
        <div className="min-w-0">
          ...
          <div className="border-b border-line pb-8">
            ...
            <div className="mt-3 h-4 w-full animate-pulse rounded-md bg-surface-2" />
            <div className="mt-2 h-4 w-5/6 animate-pulse rounded-md bg-surface-2" />
          ...
          {[0, 1, 2].map((i) => (
            <div key={i} className="mt-10">
              <div className="h-3 w-24 animate-pulse rounded-md bg-surface-2" />
              ...
              <div className="mt-4 h-24 w-full animate-pulse rounded-md bg-surface-2" />
            </div>
          ))}
        </div>
