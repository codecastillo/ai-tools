...
export default function StackError({ error, reset }: ErrorProps) {
  useEffect(() => {
    console.error('[stacks/[slug]] error:', error);
  }, [error]);
    ...
    <div className="mx-auto max-w-2xl px-6 pb-20 pt-16">
      <div className="rounded-xl border border-white/[0.06] bg-[--color-surface] p-8">
        ...
        <p className="mt-3 text-sm text-ink-mute">
          Something went wrong while fetching this stack. The database may be
