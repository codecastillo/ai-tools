          ...
          return (
            <li key={tool.id}>
              <Link
                ...
                className="group flex items-center gap-4 rounded-xl border border-white/[0.06] bg-[--color-surface] px-5 py-4 transition-all hover:-translate-y-px hover:border-white/[0.14] hover:bg-[--color-surface-hover]"
              >
