...
export const BENCHMARKS: BenchmarkRow[] = [
  {
    ...
    vendor: 'Anthropic',
    release: '2025-09',
    notes: 'Top scorer on SWE-Bench, strongest agentic coder.',
    scores: [
      { axis: 'mmlu', score: 91 },
      { axis: 'humaneval', score: 95 },
      { axis: 'math', score: 84 },
      { axis: 'gpqa', score: 71 },
      { axis: 'swebench', score: 73 },
      { axis: 'mtbench', score: 9.3 * 10 },
    ],
  },
  {
    ...
    vendor: 'Anthropic',
    release: '2025-11',
    notes: 'Default for everyday use, 1M context, big code wins.',
    scores: [
      { axis: 'mmlu', score: 88 },
      { axis: 'humaneval', score: 92 },
      { axis: 'math', score: 79 },
      { axis: 'gpqa', score: 65 },
      { axis: 'swebench', score: 67 },
