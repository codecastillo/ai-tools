...
export const LLM_RATES: LLMRate[] = [
  {
    ...
    notes: 'Latest Opus generation. Top reasoning, agentic work, long horizon tasks.',
  ...
  },
  {
    ...
    notes: 'Default workhorse. 1M context, strong code, ships in Claude Code.',
    url: 'https://www.anthropic.com/pricing',
  },
  {
    id: 'claude-haiku-4-5',
    ...
    cached_input: 0.08,
    context_window: 200_000,
    notes: 'Fast and cheap. Ideal for classification, RAG, short tasks.',
    url: 'https://www.anthropic.com/pricing',
  },
  {
    id: 'gpt-5',
